...
import type { Metric, Scaling, ScalingCurve, ScalingGroup } from "./types";
...
export function ScalingView({ filters }: { filters: Filters }) {
  ...
  const load = useCallback(async () => {
    try {
      setData(await analysisApi.scaling(toQuery(filters)));
      setError(null);
    } catch (e) {
